	...
	if (isset($_POST["register-user"]))
	{
        ...
        if (empty($errorMessage))
        {
		    ...
		    else
		    {
				...
				if (!count($result) == 1)
				{
					$errorMessage[] = "You're not allowed to register. If you're a STEP'UP member, make sure you're using the email address in the mailing lists (you can change it latter in the Profile section). If you think it's an error, please contact us.";
				}
