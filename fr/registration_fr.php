	...
	if (isset($_POST["register-user"]))
	{
        ...
        if (empty($errorMessage))
        {
		    ...
		    else
		    {
				...
				if (!count($result) == 1)
				{
					$errorMessage[] = "Vous n'êtes pas autorité à vous enregistrer. Si vous êtes membre de STEP'UP, assurez-vous d'utiliser l'adresse e-mail des listes d'envoi de l'école doctorale (vous pourrez la changer ultérieurement dans la section Profil). Si vous pensez qu'il s'agit d'une erreur, veuillez nous contacter.";
				}
